          ...
          <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col-12 col-md-8 col-lg-6 col-xl-6">
              <div class="card shadow-2-strong" style="border-radius: 2rem;">
                ...
                <h3 class="mb-2 text-center m-5 mb-5">Edit</h3>
                ...
                <div class="card-body p-5 d-flex justify-content-center align-items-center">
                  ...
                  <form action="../update_list/{{$todo_arr->id}}" class="d-flex">
                    @csrf
                    <td><input class="form-control me-3" type="text" name="todo_item" value="{{$todo_arr->todo_item}}" maxlength="50"></td>
